describe( "requireSpacesInsideJsxExpressionContainers", function() {
	var RuleFactory, rule, Checker, checker;

	before( function() {
		Checker = require( "jscs/lib/checker" );
		RuleFactory = require( "../../rules/requireSpacesInsideJsxExpressionContainers" );
	} );
	...
	describe( "check", function() {
		...
		describe( "opening curly brace", function() {
			...
			it( "should add a space when it is being fixed", function() {
